...
(function (window, document) {
  ...
  function injectStyles() {
    ...
    const css = [
      ...
      '#demy-ai-input{flex:1;padding:10px 14px;border:1.5px solid #e8e8e8;border-radius:24px;font-size:14px;outline:none;resize:none;font-family:inherit;line-height:1.4;max-height:100px;overflow-y:auto;transition:border-color .2s;}',
      ...
      '#demy-ai-footer{padding:6px 16px 10px;text-align:center;font-size:11px;color:#ccc;flex-shrink:0;background:#fff;}',
